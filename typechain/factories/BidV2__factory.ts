...
import type { BidV2, BidV2Interface } from "../BidV2";
...
export class BidV2__factory {
  static readonly abi = _abi;
  static createInterface(): BidV2Interface {
    return new utils.Interface(_abi) as BidV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BidV2 {
    return new Contract(address, _abi, signerOrProvider) as BidV2;
  }
}
