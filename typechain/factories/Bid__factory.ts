...
import type { Bid, BidInterface } from "../Bid";
...
export class Bid__factory {
  static readonly abi = _abi;
  static createInterface(): BidInterface {
    return new utils.Interface(_abi) as BidInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Bid {
    return new Contract(address, _abi, signerOrProvider) as Bid;
  }
}
